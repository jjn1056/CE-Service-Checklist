package CE::Service::Checklist::Schema::Result;
...
sub default_result_namespace { 'CE::Service::Checklist::Schema::Result' }

1;

=head1 NAME

CE::Service::Checklist::Schema::Result - The base result class

=head1 SYNOPSIS

	package CE::Service::Checklist::Schema::Result::User;
    use parent 'CE::Service::Checklist::Schema::Result';
