package CE::Service::Checklist::Schema::ResultSet;
...
CE::Service::Checklist::Schema::ResultSet - A base ResultSet Class

=head1 SYNOPSIS

    package CE::Service::Checklist::Schema::ResultSet::User;
    use parent 'CE::Service::Checklist::Schema::ResultSet';
